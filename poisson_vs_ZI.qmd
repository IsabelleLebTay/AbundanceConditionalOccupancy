...
plot(simulateResiduals(rexyPoissonTEWA))
```

The residuals from the null and random effect models are normally dispersed and distributed.
...
plot(simulateResiduals(rexyPoissonOSFL))                    
```
...
plot(simulateResiduals(rexyPoissonYRWA))                      
```
...
plot(simulateResiduals(rexyPoissonREVI))                      
```
...
plot(simulateResiduals(rexyPoissonWTSP))                      
```
...
| Model                    | Distribution Normal | Disperson Normal | Spatial correlation | AIC | Terms (related to base) |
|--------------------------|:--------------------|:-----------------|:--------------------|:----|:------------------------|
| Base                     | Yes                 |    Yes           |       None         | 830 |    Spr & Age       |
| Random effect            |  Quantile patterns   |    Yes           |       None         | 832 |    Spr & Age      |
| Spatial correlation      | Yes                 |    Yes           |    None     | 766 |    Spr, Age & xy   |
| Spatial correlation + re | Quantile patterns     |    Yes           |      None   | 768 |  Spr, Age & xy      |
